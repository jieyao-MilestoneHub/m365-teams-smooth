...
# The pure chunking helpers live in the app package (no SDK imports); the live seed and the offline
# corpus provider share them so chunk boundaries, titles, and ids stay identical.
from app.adapters.knowledge.markdown import chunk_markdown, doc_id
